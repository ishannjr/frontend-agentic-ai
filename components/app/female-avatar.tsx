...
export function FemaleAvatar({
  ...
  return (
    <div className={`relative inline-flex items-center justify-center ${className}`}>
      ...
      {/* Middle pulse ring when speaking */}
      {isSpeaking && (
        <motion.div
      ...
      {/* Main avatar circle with modern gradient background */}
      <motion.div
      ...
      >
        {/* Coach/Helper avatar - professional and friendly */}
        <svg
          width={size * 0.65}
          height={size * 0.65}
          viewBox="0 0 80 80"
